...
import 'package:boostme2/temporaries/screens/yoga/yoga_update_screen.dart';
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "${widget.yogaSnap.yogaDuration}mins",
                          style: const TextStyle(fontSize: 20.0),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "${widget.yogaSnap.yogaInstructor}",
                          style: const TextStyle(fontSize: 20.0),
                        ),
                      ],
                    ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Chip(
                          label: Text("${widget.yogaSnap.yogaDuration}mins"),
                        ),
                        const SizedBox(
                          width: 10.0,
                        ),
                        Chip(
                          label: Text("${widget.yogaSnap.yogaInstructor}"),
                        ),
                        const SizedBox(
                          width: 5.0,
                        ),
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                ...
                                settings: RouteSettings(
                                  arguments: {
                                    'date': widget.yogaSnap.yogaDate,
                                    'type': widget.yogaSnap.yogaType,
                                    'duration': widget.yogaSnap.yogaDuration,
                                    'instructor':
                                        widget.yogaSnap.yogaInstructor,
                                    'note': widget.yogaSnap.yogaNote,
