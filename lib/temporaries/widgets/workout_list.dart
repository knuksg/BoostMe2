              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Chip(
                        label: Text("${widget.workout.exWeight}kg"),
                      ),
                      const SizedBox(
                        width: 10.0,
                      ),
                      Chip(
                        label: Text("${widget.workout.exSets}sets"),
                      ),
                      const SizedBox(
                        width: 10.0,
                      ),
                      Chip(
                        label: Text("${widget.workout.exReps}reps"),
                      ),
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  ...
                                  settings: RouteSettings(
                                    arguments: {
                                      'name': widget.workout.exerciseName,
                                      'weight': widget.workout.exWeight,
                                      'reps': widget.workout.exReps,
                                      'sets': widget.workout.exSets,
                                      'date': widget.workout.exDate,
                                      'id': widget.workout.exId,
                                    },
                                  ),
                                ),
                              );
